...
if __name__ == "__main__":
    print(select_one())
    print(select_two())
    print(select_3("Вища математика"))
    print(select_4())
    print(select_5("Terry Pittman"))
    print(select_6("АА5"))
    print(select_7("ДД33", "Економіка підприємства"))
    print(select_8("Mr. Martin Finley"))
    print(select_9("James Lopez"))
    print(select_10("Nicholas Moore DDS", "Diane Burke"))
    print(select_11("Gregory Robertson", "Anna Price"))
    print(select_12())
